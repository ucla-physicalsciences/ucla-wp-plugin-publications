...
<header class="header" <?php if ( has_post_thumbnail() ) { ?> style="background-image: url(<?php echo $thumbnail[0]; ?>);" <?php } ?>>
 ...
 <?php the_content(); ?>
    ...
    <?php endwhile; endif; ?>
           <!-- All of the above is the regular  page within UCLA child theme, below, we set the columnn at the right of the content to be a listing of all the item listed inn article, to note, here they are all optional so if the user doesn't file one or multiples, no error would come up and the line associated will just not be present.-->
